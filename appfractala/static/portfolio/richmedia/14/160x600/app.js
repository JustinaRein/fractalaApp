...
function enablerInitHandler() {
	...
	devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600= [{}];
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0]._id = 0;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].id = 1;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].reportingLabel = "TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].defaultValue = true;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].startDate = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].startDate.RawValue = "";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].startDate.UtcValue = 0;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].endDate = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].endDate.RawValue = "";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].endDate.UtcValue = 0;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].startFrameText1 = "Upgrade to";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].startFrameText2 = "The home of the$Barclays Premier League";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].messageFrameText1 = "116 exclusive$live matches";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].messageFrameLockup = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].messageFrameLockup.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].messageFrameLockup.Url = "https://s0.2mdn.net/ads/richmedia/studio/37453425/36187302_20150720025815271_160x600_messageFrameLockup.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].fixtureFrameLockup = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].fixtureFrameLockup.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].fixtureFrameLockup.Url = "https://s0.2mdn.net/ads/richmedia/studio/37670526/36187302_20150804042719380_160x600_fixtureFrameLockup.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].endFrameText = "\u20AC20 sports$for 1 year";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].ctaImage = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].ctaImage.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].ctaImage.Url = "https://s0.2mdn.net/ads/richmedia/studio/37669813/36187302_20150804034252889_160x600_cta.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].legals = "<strong>Sky Fibre areas only. \\u00A36.95 router delivery charge.<\/strong>Set-up fees may apply. After 12 months, the then standard price will apply, currently \\u00A310pm plus line rental (\\u00A316.40pm). 25GB monthly usage allowance. Free TV offer: Free Samsung 32\\u201D TV for new Sky TV customers joining with any Bundle (from \\u00A320pm).One reward per household, subject to stock availability. Offer ends 13th August 2015. 12 month min & further terms apply.";
...
function adVisibilityHandler() {
    ...
    profile.startFrameText1 = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].startFrameText1;
    profile.startFrameText2 = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].startFrameText2;
    profile.messageFrameText1 = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].messageFrameText1;
	
    profile.messageFrameLockup.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].messageFrameLockup.Url;
    profile.fixtureFrameLockup.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].fixtureFrameLockup.Url;
	
    profile.endFrameText = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].endFrameText;
    profile.ctaImage.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].ctaImage.Url;
    profile.legals = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_160x600[0].legals;
...
(function (window) {
    ...
    function EndFrame(stage, profile) {    
        ...
        var txt = new SkyText(profile.endFrameText, "20px skyTextBold", null, 22, "center", gradient);
...
(function (window) {
    ...
    function StartFrame(stage, profile, channelLogo, smokeAnimation) {    
        ...
        var txt1 = new SkyText(profile.startFrameText1, "20px skyTextRegular", null, null, "center"); 
        var gradient = new SkyGradient(["#0a3075", "#0a3075", "#ed1b36", "#ed1b36"], [0, 0.1, 0.88, 1], [[0,0], [1,0]]);
        var txt2 = new SkyText(profile.startFrameText2, "20px skyTextBold", null, 22, "center", gradient); 
