...
function enablerInitHandler() {
	...
	devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600= [{}];
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0]._id = 0;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].id = 1;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].reportingLabel = "TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].defaultValue = true;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startDate = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startDate.RawValue = "";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startDate.UtcValue = 0;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].endDate = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].endDate.RawValue = "";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].endDate.UtcValue = 0;
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startFrameText1 = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startFrameText1.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startFrameText1.Url = "https://s0.2mdn.net/ads/richmedia/studio/37830592/36187302_20150813022627430_300x600_startFrameText1.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startFrameText2 = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startFrameText2.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startFrameText2.Url = "https://s0.2mdn.net/ads/richmedia/studio/37830593/36187302_20150813022633534_300x600_startFrameText2.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].messageFrameText = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].messageFrameText.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].messageFrameText.Url = "https://s0.2mdn.net/ads/richmedia/studio/37831128/36187302_20150813022620430_300x600_messageFrameText.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].messageFrameLockup = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].messageFrameLockup.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].messageFrameLockup.Url = "https://s0.2mdn.net/ads/richmedia/studio/37831344/36187302_20150813022613095_300x600_messageFrameLockup.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].fixtureFrameText = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].fixtureFrameText.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].fixtureFrameText.Url = "https://s0.2mdn.net/ads/richmedia/studio/37830166/36187302_20150813022608473_300x600_fixtureFrameText.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].endFrameText = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].endFrameText.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].endFrameText.Url = "https://s0.2mdn.net/ads/richmedia/studio/37830165/36187302_20150813022603094_300x600_endFrameText.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].ctaImage = {};
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].ctaImage.Type = "file";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].ctaImage.Url = "https://s0.2mdn.net/ads/richmedia/studio/37830843/36187302_20150813022556198_300x600_cta.png";
    devDynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].legals = "Available to Sky TV customers joining with or upgrading to Sky Sports. Replaces existing Sky TV offers. After 12 months you’ll continue to pay standard price for Sky Sports (€36 extra pm) unless you cancel giving at least 31 days’ notice. Offer ends 1 October 2015.";
...
function adVisibilityHandler() {
    ...
    profile.startFrameText1.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startFrameText1.Url;
    profile.startFrameText2.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].startFrameText2.Url;
    profile.messageFrameText.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].messageFrameText.Url;
    profile.messageFrameLockup.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].messageFrameLockup.Url;
    profile.fixtureFrameText.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].fixtureFrameText.Url;
    profile.endFrameText.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].endFrameText.Url;
    profile.ctaImage.url = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].ctaImage.Url;
    profile.legals = dynamicContent.TRADING_ROI_SOS_CUSTOMER_EURO20_SPORTS_300x600[0].legals;
...
(function (window) {
    ...
    function Main(profile) {    
		...
		glassmark.x = stage.canvas.width * 0.5 - glassmark.image.width * 0.5;
		glassmark.y = 524;
		footerContainer.addChild(glassFrameBottom, glassmark);
		
		trophy.x = stage.canvas.width - trophy.width;
        trophy.y = 305;
		trophy.alpha = 0;
        stage.addChild(glassFrameTop, trophy);
        ...
        var startFrame = new StartFrame(stage, profile, channelLogo, smokeAnimation, trophy);
        framesArray.push(startFrame);
            
        var messageFrame = new MessageFrame(stage, profile, channelLogo, messageFrameLockup);
        framesArray.push(messageFrame);
        
		var fixtureFrame = new FixtureFrame(stage, profile, messageFrameLockup);
        framesArray.push(fixtureFrame);
       
        var endFrame = new EndFrame(stage, profile, trophy);
...
(function (window) {
    ...
    function SmokeAnimation(stage, profile) {    
        ...
        this.animate = function() {
            ...
            TweenMax.to(smoke1, 4.4 * speed, { delay:0.5 * speed, scaleX: 0.40, scaleY: 0.50, x:0, y: 0, rotation:51.9, ease: Linear.easeNone });
            ...
            TweenMax.to(smoke2, 4.7 * speed, { delay:0.2 * speed, scaleX: 0.62, scaleY: 0.77, x: -50, y: -100, rotation:93.1, ease: Linear.easeNone });
...
(function (window) {
    ...
    function EndFrame(stage, profile, trophy) {    
        ...
        this.animate = function(animationComplete) {
			...
			TweenLite.to(trophy, 1, { alpha: 1 });
			TweenLite.to(trophy, 0.5, { x: stage.canvas.width - trophy.width, ease:Linear.easeNone });
...
(function (window) {
    ...
    function FixtureFrame(stage, profile, messageFrameLockup) {    
         
        var fixtureFrameText = new createjs.Bitmap(profile.fixtureFrameText.img);
		
		fixtureFrameText.x = stage.canvas.width;
        
        this.animate = function(animationComplete) {
			stage.addChild(fixtureFrameText);
			
            TweenLite.to(fixtureFrameText, 0.5, {x: 0, ease:Linear.easeNone});
            
            TweenLite.to(fixtureFrameText, 0.8, { delay: 3.5, alpha: 0,  ease:Quad.easeOut });
			TweenLite.to(messageFrameLockup, 0.8, { delay: 3.5, alpha: 0,  ease:Quad.easeOut });
            
            TweenLite.delayedCall(4.5, function(){
                stage.removeChild(fixtureFrameText, messageFrameLockup); 
                animationComplete();
            })
        }
    }
...
(function (window) {
    ...
    function MessageFrame(stage, profile, channelLogo, messageFrameLockup) {    
        ...
        this.animate = function(animationComplete) {
            ...
            stage.addChildAt(messageFrameLockup, messageFrameText, channelLogo, stage.getNumChildren() - 2);
			
            TweenLite.to(channelLogo, 1, { alpha: 1, ease:Quad.easeOut});
            TweenLite.to(messageFrameText, 1, { alpha: 1, ease:Quad.easeOut});
            TweenLite.to(messageFrameLockup, 1, { alpha: 1, ease:Quad.easeOut});
            
            TweenLite.to(messageFrameText, 0.5, { delay: 3.8, x: 0 - messageFrameText.image.width, ease:Quad.easeIn});
...
(function (window) {
    ...
    function StartFrame(stage, profile, channelLogo, smokeAnimation, trophy) {    
        
        var startFrameText1 = new createjs.Bitmap(profile.startFrameText1.img); 
        var startFrameText2 = new createjs.Bitmap(profile.startFrameText2.img); 
        ...
        this.animate = function(animationComplete) {
            ...
            stage.addChildAt(channelLogo, startFrameText1, startFrameText2, stage.getNumChildren() - 2);
			...
			TweenLite.to(trophy, 0.5, { delay: 4, x: stage.canvas.width, alpha: 0, ease:Quad.easeIn});
            
            TweenLite.delayedCall(5.1, function(){
                stage.removeChild(channelLogo, startFrameText1, startFrameText2); 
                animationComplete();
            })
        }
    }
