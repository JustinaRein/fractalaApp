...
function adVisibilityHandler() {
	...
	queue.loadFile({id:"background", src: dynamicContent.Feed_120x600[0].content['background.jpg'].Url});
	queue.loadFile({id:"bundle_full_a", src: dynamicContent.Feed_120x600[0].content['bundle_full_a.png'].Url});
	queue.loadFile({id:"bundle_full_b", src: dynamicContent.Feed_120x600[0].content['bundle_full_b.png'].Url});
	queue.loadFile({id:"bundle_full", src: dynamicContent.Feed_120x600[0].content['bundle_full.jpg'].Url});
	
	queue.loadFile({id:"bundle", src: dynamicContent.Feed_120x600[0].content['bundle.png'].Url});
	queue.loadFile({id:"bundle_1", src: dynamicContent.Feed_120x600[0].content['bundle_1.png'].Url});
	queue.loadFile({id:"bundle_2", src: dynamicContent.Feed_120x600[0].content['bundle_2.png'].Url});
	queue.loadFile({id:"bundle_3", src: dynamicContent.Feed_120x600[0].content['bundle_3.png'].Url});
	...
	queue.loadFile({id:"headline_2", src: dynamicContent.Feed_120x600[0].content['headline_2.png'].Url});
	queue.loadFile({id:"headline_3", src: dynamicContent.Feed_120x600[0].content['headline_3.png'].Url});
...
function Frame01(stage, assets) {
	...
	this.animate = function(animationComplete) { 
		...
		TweenMax.to(bundle, 0.5, {force3D: true, y: 310, ease:"hop"});
		...
		TweenMax.to(bundle, 3.5, {delay: 0.2, force3D: true, x: 10, ease:Linear.easeNone});
		
		TweenMax.to(bundle, 0.3, {delay: 3.5, force3D: true, x:-380, y: 380, scaleX: 2, scaleY: 2.6, ease:Linear.easeNone});
...
function Frame02(stage, assets) {
	...
	this.animate = function(animationComplete) { 
		...
		TweenMax.to(mainContainer, 0.3, {force3D: true, x: - 145, y: 340, scaleX: 1, scaleY: 1, ease:Linear.easeNone});
		...
		TweenMax.to(mainContainer, 0.3, {delay: 3.5, force3D: true, x: - 125 - bundle_top.image.width, ease:Linear.easeNone});
...
function Frame03(stage, assets) {
	...
	mainContainer.y = 340;
	mainContainer.x = bundle.image.width - 145;
	mainContainer.scaleX = 0;
	...
	this.animate = function(animationComplete) { 
		...
		TweenMax.to(mainContainer, 0.3, {force3D: true, x: - 145, scaleX: 1, ease:Linear.easeNone});
		TweenMax.to(bundle, 0.2, {delay: 0.1, force3D: true, scaleY: 1, ease:Linear.easeNone});
		TweenMax.to(bundle, 0.2, {delay: 0.1, force3D: true, scaleX: 1, ease:Linear.easeNone});
		...
		TweenMax.to(mainContainer, 0.3, {delay: 3.5, force3D: true, x: - 125 - bundle.image.width, ease:Linear.easeNone});
		TweenMax.to(bundle_top, 0, {delay: 3.5, regX: bundle_top.image.width, x: bundle_top.image.width, overwrite: 0});
		TweenMax.to(bundle_bottom, 0, {delay: 3.5, regX: bundle_bottom.image.width, x: bundle_bottom.image.width, overwrite: 0});
		TweenMax.to(bundle, 0.2, {delay: 3.6, force3D: true, scaleY: 0.2, ease:Linear.easeNone});
		TweenMax.to(bundle, 0.2, {delay: 3.6, force3D: true, scaleX: 0.8, ease:Linear.easeNone});
