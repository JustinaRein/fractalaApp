...
function enablerInitHandler() {
    ...
    devDynamicContent.Feed_160x600[0].ReportingLabel = "OSM_AQ_DTH_POWERFORTNIGHT-Q2_FREETABEORVOUCHER_SKYTV_100ROUNDEL_HTML5_294535";
    devDynamicContent.Feed_160x600[0].Clicktag = {};
    devDynamicContent.Feed_160x600[0].Clicktag.Url = "https://secure.sky.com/";
	...
	devDynamicContent.Feed_160x600[0].content = {
		"160x600_opening_image.jpg":{"Type":"file","Url":"dynamic_assets/160x600_opening_image.jpg"},
		"160x600_opening_copy_01.png":{"Type":"file","Url":"dynamic_assets/160x600_opening_copy_01.png"},
		"160x600_opening_copy_02.png":{"Type":"file","Url":"dynamic_assets/160x600_opening_copy_02.png"},
		
		"160x600_f1_headline.png":{"Type":"file","Url":"dynamic_assets/160x600_f1_headline.png"},
		"160x600_f1_image_left.png":{"Type":"file","Url":"dynamic_assets/160x600_f1_image_left.png"},
		"160x600_f1_image_right.png":{"Type":"file","Url":"dynamic_assets/160x600_f1_image_right.png"},
		
		"160x600_f2_headline.png":{"Type":"file","Url":"dynamic_assets/160x600_f2_headline.png"},
		"160x600_f2_image_left.png":{"Type":"file","Url":"dynamic_assets/160x600_f2_image_left.png"},
		"160x600_f2_image_middle.png":{"Type":"file","Url":"dynamic_assets/160x600_f2_image_middle.png"},
		"160x600_f2_image_right.png":{"Type":"file","Url":"dynamic_assets/160x600_f2_image_right.png"},
		
		"160x600_f3_headline.png":{"Type":"file","Url":"dynamic_assets/160x600_f3_headline.png"},
		"160x600_f3_image.png":{"Type":"file","Url":"dynamic_assets/160x600_f3_image.png"},
		"160x600_f3_headline_legals.png":{"Type":"file","Url":"dynamic_assets/160x600_f3_headline_legals.png"},
		
		"160x600_cta.png":{"Type":"file","Url":"dynamic_assets/160x600_cta.png"},
		"160x600_background.jpg":{"Type":"file","Url":"dynamic_assets/160x600_background.jpg"},
		"160x600_sky_logo.png":{"Type":"file","Url":"dynamic_assets/160x600_sky_logo.png"}};
...
function adVisibilityHandler() {
	...
	profile.background.url = dynamicContent.Feed_160x600[0].content['160x600_background.jpg']['Url'];
    profile.glassmark.url = dynamicContent.Feed_160x600[0].content['160x600_sky_logo.png']['Url'];
    profile.cta.url = dynamicContent.Feed_160x600[0].content['160x600_cta.png']['Url'];
	
    profile.opening_image.url = dynamicContent.Feed_160x600[0].content['160x600_opening_image.jpg']['Url'];
	profile.opening_copy_01.url = dynamicContent.Feed_160x600[0].content['160x600_opening_copy_01.png']['Url'];
	profile.opening_copy_02.url = dynamicContent.Feed_160x600[0].content['160x600_opening_copy_02.png']['Url'];
	
	profile.f1_headline.url = dynamicContent.Feed_160x600[0].content['160x600_f1_headline.png']['Url'];
	profile.f1_image_left.url = dynamicContent.Feed_160x600[0].content['160x600_f1_image_left.png']['Url'];
	profile.f1_image_right.url = dynamicContent.Feed_160x600[0].content['160x600_f1_image_right.png']['Url'];
	
	profile.f2_headline.url = dynamicContent.Feed_160x600[0].content['160x600_f2_headline.png']['Url'];
	profile.f2_image_left.url = dynamicContent.Feed_160x600[0].content['160x600_f2_image_left.png']['Url'];
	profile.f2_image_middle.url = dynamicContent.Feed_160x600[0].content['160x600_f2_image_middle.png']['Url'];
	profile.f2_image_right.url = dynamicContent.Feed_160x600[0].content['160x600_f2_image_right.png']['Url'];
	
	profile.f3_headline.url = dynamicContent.Feed_160x600[0].content['160x600_f3_headline.png']['Url'];
	profile.f3_image.url = dynamicContent.Feed_160x600[0].content['160x600_f3_image.png']['Url'];
	profile.f3_headline_legals.url = dynamicContent.Feed_160x600[0].content['160x600_f3_headline_legals.png']['Url'];

    profile.legalShow = dynamicContent.Feed_160x600[0].LegalButton;
    profile.legals =  dynamicContent.Feed_160x600[0].LegalCopy;
...
function f1() {
	...
	TweenMax.to(opening_image, 3, {scaleX: 1, scaleY: 1, y: 325});
...
function f2() {
	...
	TweenMax.to(f1_image_left, 0.7, {x: -180, ease: Quad.easeOut});
	TweenMax.to(f1_image_right, 0.7, {x: -180, ease: Quad.easeOut});
...
function f3() {
	...
	TweenMax.to(f2_image_left, 0.5, {x: -160, ease: Quad.easeOut});
	TweenMax.to(f2_image_middle, 0.5, {x: -160, ease: Quad.easeOut});
	TweenMax.to(f2_image_right, 0.5, {x: -160, ease: Quad.easeOut});
