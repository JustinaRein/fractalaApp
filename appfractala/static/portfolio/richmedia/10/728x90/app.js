...
function enablerInitHandler() {
	...
	devDynamicContent.Feed_728x90[0].content = {
		"728x90_opening_image.jpg":{"Type":"file","Url":"dynamic_assets/728x90_opening_image.jpg"},
		"728x90_opening_copy_01.png":{"Type":"file","Url":"dynamic_assets/728x90_opening_copy_01.png"},
		"728x90_opening_copy_02.png":{"Type":"file","Url":"dynamic_assets/728x90_opening_copy_02.png"},
		
		"728x90_f1_headline.png":{"Type":"file","Url":"dynamic_assets/728x90_f1_headline.png"},
		"728x90_f1_image_left.png":{"Type":"file","Url":"dynamic_assets/728x90_f1_image_left.png"},
		"728x90_f1_image_right.png":{"Type":"file","Url":"dynamic_assets/728x90_f1_image_right.png"},
		
		"728x90_f2_headline.png":{"Type":"file","Url":"dynamic_assets/728x90_f2_headline.png"},
		"728x90_f2_image_left.png":{"Type":"file","Url":"dynamic_assets/728x90_f2_image_left.png"},
		"728x90_f2_image_middle.png":{"Type":"file","Url":"dynamic_assets/728x90_f2_image_middle.png"},
		"728x90_f2_image_right.png":{"Type":"file","Url":"dynamic_assets/728x90_f2_image_right.png"},
		
		"728x90_f3_headline.png":{"Type":"file","Url":"dynamic_assets/728x90_f3_headline.png"},
		"728x90_f3_image.png":{"Type":"file","Url":"dynamic_assets/728x90_f3_image.png"},
		"728x90_f3_headline_legals.png":{"Type":"file","Url":"dynamic_assets/728x90_f3_headline_legals.png"},
		
		"728x90_cta.png":{"Type":"file","Url":"dynamic_assets/728x90_cta.png"},
    ...
    devDynamicContent.Feed_728x90[0].LegalCopy = "Lucky Man Steffan Hill / 2015 Carnival Films. The Blacklist Season 3 © 2015 Sony Pictures Television Inc and Open 4 Business Productions LLC. All Rights Reserved.";
...
function adVisibilityHandler() {
    ...
    profile.cta.url = dynamicContent.Feed_728x90[0].content['728x90_cta.png']['Url'];
	
    profile.opening_image.url = dynamicContent.Feed_728x90[0].content['728x90_opening_image.jpg']['Url'];
	profile.opening_copy_01.url = dynamicContent.Feed_728x90[0].content['728x90_opening_copy_01.png']['Url'];
	profile.opening_copy_02.url = dynamicContent.Feed_728x90[0].content['728x90_opening_copy_02.png']['Url'];
	
	profile.f1_headline.url = dynamicContent.Feed_728x90[0].content['728x90_f1_headline.png']['Url'];
	profile.f1_image_left.url = dynamicContent.Feed_728x90[0].content['728x90_f1_image_left.png']['Url'];
	profile.f1_image_right.url = dynamicContent.Feed_728x90[0].content['728x90_f1_image_right.png']['Url'];
	
	profile.f2_headline.url = dynamicContent.Feed_728x90[0].content['728x90_f2_headline.png']['Url'];
	profile.f2_image_left.url = dynamicContent.Feed_728x90[0].content['728x90_f2_image_left.png']['Url'];
	profile.f2_image_middle.url = dynamicContent.Feed_728x90[0].content['728x90_f2_image_middle.png']['Url'];
	profile.f2_image_right.url = dynamicContent.Feed_728x90[0].content['728x90_f2_image_right.png']['Url'];
	
	profile.f3_headline.url = dynamicContent.Feed_728x90[0].content['728x90_f3_headline.png']['Url'];
	profile.f3_image.url = dynamicContent.Feed_728x90[0].content['728x90_f3_image.png']['Url'];
	profile.f3_headline_legals.url = dynamicContent.Feed_728x90[0].content['728x90_f3_headline_legals.png']['Url'];
...
function Main(profile) {
	...
	opening_image.x = 364;
	opening_image.y = 45;
	opening_image.scaleX = 1.1;
	opening_image.scaleY = 1.1;
	
	openingCopy = new Glintable(opening_copy_02, 1, 3);
	
	f1_image_left.regX = f1_image_left.image.width * 0.5;
	f1_image_left.regY = f1_image_left.image.height * 0.5;
	f1_image_left.x = 160;
	f1_image_left.y = 80;
	f1_image_left.scaleX = 2.7;
	f1_image_left.scaleY = 2.7;
	
	f1_image_right.alpha = 0;
	
	f1Text = new Glintable(f1_headline, 0.7, 3);
	f1Text.alpha = 0;
...
function f1() {
	...
	TweenMax.to(f1_image_left, 0.5, {delay: 2, scaleX: 1, scaleY: 1, x: 364, y: 45});
	
	TweenMax.to(f1_image_right, 0.5, {delay: 2.6, alpha: 1});
...
function f2() {
	...
	TweenMax.to(f1_image_left, 0.5, {alpha: 0, ease: Quad.easeOut});
	TweenMax.to(f1_image_right, 0.5, {alpha: 0, ease: Quad.easeOut});
	
	f2Text = new Glintable(f2_headline, 0.7, 3);
	f2Text.alpha = 0;
	f2_image_left.y = -250;
...
function f3() {
	...
	TweenMax.to(f2_image_left, 0.5, {alpha: 0, ease: Quad.easeOut});
	TweenMax.to(f2_image_middle, 0.5, {alpha: 0, ease: Quad.easeOut});
	TweenMax.to(f2_image_right, 0.5, {alpha: 0, ease: Quad.easeOut});
	
	f3Text = new Glintable(f3_headline, 0.7, 3);
	f3Text.alpha = 0;

	ctaImage = new Glintable(cta, 0.3, 2);
	ctaImage.alpha = 0;
	...
	TweenMax.to(f3Text, 0.7, {delay: 0.5, alpha: 1, ease: Quad.easeOut});
	TweenMax.to(f3_headline_legals, 0.7, {delay: 0.5, alpha: 1, ease: Quad.easeOut});
	TweenMax.to(f3_image, 0.7, {delay: 0.7, alpha: 1, ease: Quad.easeOut});
	TweenMax.to(ctaImage, 0.7, {delay: 0.9, alpha: 1, ease: Quad.easeOut});
	
	TweenMax.delayedCall(1.5, f3Text.playGlint);
	TweenMax.delayedCall(2, ctaImage.playGlint);
