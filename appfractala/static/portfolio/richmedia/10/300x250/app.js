...
function enablerInitHandler() {
    ...
    devDynamicContent.Feed_300x250[0].ReportingLabel = "OSM_AQ_DTH_POWERFORTNIGHT-Q2_FREETABEORVOUCHER_SKYTV_100ROUNDEL_HTML5_294535";
    devDynamicContent.Feed_300x250[0].Clicktag = {};
    devDynamicContent.Feed_300x250[0].Clicktag.Url = "https://secure.sky.com/";
	...
	devDynamicContent.Feed_300x250[0].content = {
		"300x250_opening_image.jpg":{"Type":"file","Url":"dynamic_assets/300x250_opening_image.jpg"},
		"300x250_opening_copy_01.png":{"Type":"file","Url":"dynamic_assets/300x250_opening_copy_01.png"},
		"300x250_opening_copy_02.png":{"Type":"file","Url":"dynamic_assets/300x250_opening_copy_02.png"},
		
		"300x250_f1_headline.png":{"Type":"file","Url":"dynamic_assets/300x250_f1_headline.png"},
		"300x250_f1_image_left.png":{"Type":"file","Url":"dynamic_assets/300x250_f1_image_left.png"},
		"300x250_f1_image_right.png":{"Type":"file","Url":"dynamic_assets/300x250_f1_image_right.png"},
		
		"300x250_f2_headline.png":{"Type":"file","Url":"dynamic_assets/300x250_f2_headline.png"},
		"300x250_f2_image_left.png":{"Type":"file","Url":"dynamic_assets/300x250_f2_image_left.png"},
		"300x250_f2_image_middle.png":{"Type":"file","Url":"dynamic_assets/300x250_f2_image_middle.png"},
		"300x250_f2_image_right.png":{"Type":"file","Url":"dynamic_assets/300x250_f2_image_right.png"},
		
		"300x250_f3_headline.png":{"Type":"file","Url":"dynamic_assets/300x250_f3_headline.png"},
		"300x250_f3_image.png":{"Type":"file","Url":"dynamic_assets/300x250_f3_image.png"},
		"300x250_f3_headline_legals.png":{"Type":"file","Url":"dynamic_assets/300x250_f3_headline_legals.png"},
		
		"300x250_cta.png":{"Type":"file","Url":"dynamic_assets/300x250_cta.png"},
		"300x250_background.jpg":{"Type":"file","Url":"dynamic_assets/300x250_background.jpg"},
		"300x250_sky_logo.png":{"Type":"file","Url":"dynamic_assets/300x250_sky_logo.png"}};
...
function adVisibilityHandler() {
	...
	profile.background.url = dynamicContent.Feed_300x250[0].content['300x250_background.jpg']['Url'];
    profile.glassmark.url = dynamicContent.Feed_300x250[0].content['300x250_sky_logo.png']['Url'];
    profile.cta.url = dynamicContent.Feed_300x250[0].content['300x250_cta.png']['Url'];
	
    profile.opening_image.url = dynamicContent.Feed_300x250[0].content['300x250_opening_image.jpg']['Url'];
	profile.opening_copy_01.url = dynamicContent.Feed_300x250[0].content['300x250_opening_copy_01.png']['Url'];
	profile.opening_copy_02.url = dynamicContent.Feed_300x250[0].content['300x250_opening_copy_02.png']['Url'];
	
	profile.f1_headline.url = dynamicContent.Feed_300x250[0].content['300x250_f1_headline.png']['Url'];
	profile.f1_image_left.url = dynamicContent.Feed_300x250[0].content['300x250_f1_image_left.png']['Url'];
	profile.f1_image_right.url = dynamicContent.Feed_300x250[0].content['300x250_f1_image_right.png']['Url'];
	
	profile.f2_headline.url = dynamicContent.Feed_300x250[0].content['300x250_f2_headline.png']['Url'];
	profile.f2_image_left.url = dynamicContent.Feed_300x250[0].content['300x250_f2_image_left.png']['Url'];
	profile.f2_image_middle.url = dynamicContent.Feed_300x250[0].content['300x250_f2_image_middle.png']['Url'];
	profile.f2_image_right.url = dynamicContent.Feed_300x250[0].content['300x250_f2_image_right.png']['Url'];
	
	profile.f3_headline.url = dynamicContent.Feed_300x250[0].content['300x250_f3_headline.png']['Url'];
	profile.f3_image.url = dynamicContent.Feed_300x250[0].content['300x250_f3_image.png']['Url'];
	profile.f3_headline_legals.url = dynamicContent.Feed_300x250[0].content['300x250_f3_headline_legals.png']['Url'];

    profile.legalShow = dynamicContent.Feed_300x250[0].LegalButton;
    profile.legals =  dynamicContent.Feed_300x250[0].LegalCopy;
...
function Main(profile) {
	...
	f1_image_left.x = 165;
	f1_image_left.y = 105;
	f1_image_left.scaleX = 2;
	f1_image_left.scaleY = 2;
	
	f1_image_right.x = 300;
...
function f1() {
	...
	TweenMax.to(f1_image_left, 0.5, {delay: 2, scaleX: 1, scaleY: 1, x: 150, y: 125});
...
function f2() {
	...
	TweenMax.to(f1_image_left, 0.7, {x: -150, ease: Quad.easeOut});
	TweenMax.to(f1_image_right, 0.7, {x: -300, ease: Quad.easeOut});
	
	f2Text = new Glintable(f2_headline, 0.7, 1.5);
	f2Text.alpha = 0;
	f2_image_left.y = -250;
	f2_image_middle.y = -250;
	f2_image_right.y = -250;
	
	stage.addChild(f2Text, f2_image_left, f2_image_middle, f2_image_right);
	
	TweenMax.to(f2_image_left, 0.3, {delay: 0.5, y: 0, ease: Bounce.easeOut});
	TweenMax.to(f2_image_middle, 0.3, {delay: 0.7, y: 0, ease: Bounce.easeOut});
	TweenMax.to(f2_image_right, 0.3, {delay: 0.9, y: 0, ease: Bounce.easeOut});
	TweenMax.to(f2Text, 0.7, {delay: 1.1, alpha: 1, ease: Quad.easeIn});
	TweenMax.delayedCall(1.7, f2Text.playGlint);
...
function f3() {
	...
	TweenMax.to(f2_image_left, 0.7, {x: -300, ease: Quad.easeOut});
	TweenMax.to(f2_image_middle, 0.7, {x: -300, ease: Quad.easeOut});
	TweenMax.to(f2_image_right, 0.7, {x: -300, ease: Quad.easeOut});
	...
	TweenMax.to(f3_image, 0.7, {delay: 0.5, x: 0, ease: Quad.easeOut});
	TweenMax.to(f3Text, 0.7, {delay: 1.3, alpha: 1, ease: Quad.easeOut});
	TweenMax.to(f3_headline_legals, 0.7, {delay: 1.3, alpha: 1, ease: Quad.easeOut});
	TweenMax.delayedCall(2, f3Text.playGlint);
	TweenMax.to(ctaImage, 0.7, {delay: 1.3, alpha: 1, ease: Quad.easeOut});
