...
function enablerInitHandler() {
    ...
    devDynamicContent.Feed_160x600[0].LegalCopy = "TBC";
...
function adVisibilityHandler() {
	...
	queue.loadFile({id:"background", src: dynamicContent.Feed_160x600[0].content['background_sky.jpg'].Url});
	
	queue.loadFile({id:"bundle", src: dynamicContent.Feed_160x600[0].content['bundle.png'].Url});
	
	queue.loadFile({id:"air_balloon_bridget_jones", src: dynamicContent.Feed_160x600[0].content['air_balloon_bridget_jones.png'].Url});
	queue.loadFile({id:"air_balloon_dory", src: dynamicContent.Feed_160x600[0].content['air_balloon_dory.png'].Url});
	queue.loadFile({id:"air_balloon_fantastic_beasts", src: dynamicContent.Feed_160x600[0].content['air_balloon_fantastic_beasts.png'].Url});
	queue.loadFile({id:"air_balloon_offer", src: dynamicContent.Feed_160x600[0].content['air_balloon_offer.png'].Url});
	queue.loadFile({id:"air_balloon_red_blue", src: dynamicContent.Feed_160x600[0].content['air_balloon_red_blue.png'].Url});
	queue.loadFile({id:"air_balloon_pet", src: dynamicContent.Feed_160x600[0].content['air_balloon_pet.png'].Url});
	queue.loadFile({id:"air_balloon_trolls", src: dynamicContent.Feed_160x600[0].content['air_balloon_trolls.png'].Url});
	...
	queue.loadFile({id:"headline_6_1", src: dynamicContent.Feed_160x600[0].content['headline_6_1.png'].Url});
	queue.loadFile({id:"headline_6_2", src: dynamicContent.Feed_160x600[0].content['headline_6_2.png'].Url});
