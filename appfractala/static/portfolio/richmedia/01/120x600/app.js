...
function enablerInitHandler() {
    ...
    devDynamicContent.Feed_120x600[0].ReportingLabel = "ReportingLabel";
    devDynamicContent.Feed_120x600[0].Clicktag = {};
    devDynamicContent.Feed_120x600[0].Clicktag.Url = "https://www.sky.com/";
    ...
    devDynamicContent.Feed_120x600[0].LegalCopy = "TBC";
...
function adVisibilityHandler() {
	...
	queue.loadFile({id:"background", src: dynamicContent.Feed_120x600[0].content['background_sky.jpg'].Url});
	
	queue.loadFile({id:"bundle", src: dynamicContent.Feed_120x600[0].content['bundle.png'].Url});
	
	queue.loadFile({id:"air_balloon_bridget_jones", src: dynamicContent.Feed_120x600[0].content['air_balloon_bridget_jones.png'].Url});
	queue.loadFile({id:"air_balloon_dory", src: dynamicContent.Feed_120x600[0].content['air_balloon_dory.png'].Url});
	queue.loadFile({id:"air_balloon_fantastic_beasts", src: dynamicContent.Feed_120x600[0].content['air_balloon_fantastic_beasts.png'].Url});
	queue.loadFile({id:"air_balloon_offer", src: dynamicContent.Feed_120x600[0].content['air_balloon_offer.png'].Url});
	queue.loadFile({id:"air_balloon_red_blue", src: dynamicContent.Feed_120x600[0].content['air_balloon_red_blue.png'].Url});
	queue.loadFile({id:"air_balloon_pet", src: dynamicContent.Feed_120x600[0].content['air_balloon_pet.png'].Url});
	queue.loadFile({id:"air_balloon_trolls", src: dynamicContent.Feed_120x600[0].content['air_balloon_trolls.png'].Url});
	
	queue.loadFile({id:"sky_logo", src: dynamicContent.Feed_120x600[0].content['sky_logo.png'].Url});
	queue.loadFile({id:"cta", src: dynamicContent.Feed_120x600[0].content['cta.png'].Url});
	
	queue.loadFile({id:"headline_1", src: dynamicContent.Feed_120x600[0].content['headline_1.png'].Url});
	queue.loadFile({id:"headline_4", src: dynamicContent.Feed_120x600[0].content['headline_4.png'].Url});
	queue.loadFile({id:"headline_5", src: dynamicContent.Feed_120x600[0].content['headline_5.png'].Url});
	queue.loadFile({id:"headline_5_legal", src: dynamicContent.Feed_120x600[0].content['headline_5_legal.png'].Url});
	queue.loadFile({id:"headline_6_1", src: dynamicContent.Feed_120x600[0].content['headline_6_1.png'].Url});
	queue.loadFile({id:"headline_6_2", src: dynamicContent.Feed_120x600[0].content['headline_6_2.png'].Url});
...
function Main(assets) {
    ...
    maskShape.graphics.f('#fff').dr(0, 0, stage.canvas.width, 125);
	var mask = new createjs.Shape();
    mask.graphics.beginLinearGradientFill(['transparent', '#f00'], [0, 1], 0, 0, 0, 50).drawRect(0, 0, stage.canvas.width, 125);
	mask.cache(0, 0, stage.canvas.width, 125);
	maskShape.filters = [
		new createjs.AlphaMaskFilter(mask.cacheCanvas)
	];
	maskShape.cache(0, 0, stage.canvas.width, 125);
	
	maskShape.y = stage.canvas.height - 125;
	
	var headlineContainer = new createjs.Container();
	headlineContainer.name = 'headlineContainer';
	
	stage.addChild(backgroundContainer, balloonContainer, headlineContainer, maskShape,logoContainer);
...
function Frame01(stage, assets) {
	...
	var headline_1 = new Glintable(new createjs.Bitmap(assets.headline_1.img), 0.6, 4);
	...
	headline_1.alpha = 0;
	headline_1.regY = 150;
	headline_1.y  = stage.canvas.height * 0.5;
	//var path = new createjs.Shape();
	//path.graphics.beginStroke("#ff00ff").moveTo(stage.canvas.width + airBalloonContainer.getBounds().width * 0.5, 170).quadraticCurveTo(150,140,-airBalloon.image.width * 0.5,140);
	...
	this.animate = function(animationComplete) { 
		...
		createjs.Tween.get(headline_1).wait(500).to({alpha: 1}, 500).call(function(){headline_1.playGlint();}).wait(1250).to({alpha: 0}, 750);
		...
		createjs.Tween.get(airBalloonContainer).to({scaleX: 0.9, scaleY: 0.9, guide:{ path:[stage.canvas.width + airBalloonContainer.getBounds().width * 0.5, 170, 150,140, 0 - airBalloon.image.width * 0.5,140] }}, 3500);
		
		createjs.Tween.get(stage.getChildByName('backgroundContainer')).to({x: 0 - stage.getChildByName('backgroundContainer').getChildByName('background').getBounds().width * 0.3}, 25000, createjs.Ease.linear).to({x: 0 - stage.getChildByName('backgroundContainer').getChildByName('background').getBounds().width + stage.canvas.width + 200}, 55000, createjs.Ease.linear);
		//3000 + 6500 + 8500 + 4000 + 3500 + 3250 = 28750
		createjs.Tween.get(stage.getChildByName('backgroundContainer').getChildByName('background'))
			.wait(17000).to({x: -120}, 2000, createjs.Ease.sineIn) // frame 3 - frame 4 - 3500
			.wait(2500).to({y: -600}, 1000, createjs.Ease.linear) //frame 4 - frame 5 - 3500
			.wait(3000).to({y: 0}, 1000, createjs.Ease.linear); // frame 5 - frame 6 - 4000
...
function Frame02(stage, assets) {
	...
	airBalloon_2.scaleX = 1.2;
	airBalloon_2.scaleY = 1.2;
	airBalloon_2.x = balloonContainer.getBounds().width + airBalloon_2.image.width * 1.2 * 0.5;
	airBalloon_2.y = 150;
	airBalloon_2.rotation = 10;
	
	airBalloon_1.regX = airBalloon_1.image.width * 0.5;
	airBalloon_1.regY = airBalloon_1.image.height * 0.5;
	airBalloon_1.scaleX = 1.2;
	airBalloon_1.scaleY = 1.2;
	airBalloon_1.x = balloonContainer.getBounds().width + airBalloon_1.image.width * 1.2 * 0.5;
	airBalloon_1.y = 380;
	airBalloon_1.rotation = 10;
	
	this.animate = function(animationComplete) { 
		stage.getChildByName('balloonContainer').addChild(balloonContainer);
		
		createjs.Tween.get(airBalloon_1).wait(2000).to({rotation: -10, scaleX: 0.8, scaleY: 0.8, x: 0 - airBalloon_1.image.width * 0.5}, 6000, createjs.Ease.linear);
		
		createjs.Tween.get(airBalloon_2).to({rotation: -10, scaleX: 0.8, scaleY: 0.8, x: 0 - airBalloon_2.image.width * 0.5}, 5000, createjs.Ease.linear);
		
		createjs.Tween.get().wait(6500).call(function(){
			animationComplete();
		});
	};
}
...
function Frame03(stage, assets) {
	...
	balloonContainer.y = balloonContainer.getBounds().height * 0.5 + 30;
	
	airBalloon.regX = airBalloon.image.width * 0.5;
	airBalloon.regY = airBalloon.image.height * 0.5;
	airBalloon.scaleX = 1.4;
	airBalloon.scaleY = 1.4;
	...
	this.animate = function(animationComplete) { 
		...
		createjs.Tween.get(balloonContainer).to({x: balloonContainer.getBounds().width * 0.5 + 10, y: balloonContainer.getBounds().height * 0.5}, 4000, createjs.Ease.sineOut).to({x: balloonContainer.getBounds().width * 0.5 - 10, y: balloonContainer.getBounds().height * 0.5 - 20}, 3000, createjs.Ease.sineInOut).to({x: 0 - balloonContainer.getBounds().width * 0.5 - 10, y: balloonContainer.getBounds().height * 0.5 - 30}, 2000, createjs.Ease.sineIn)
		
		createjs.Tween.get(airBalloon).to({rotation: -1, scaleX: 1.1, scaleY: 1.1}, 4000, createjs.Ease.linear).to({rotation: 1, scaleX: 0.9, scaleY: 0.9}, 3000, createjs.Ease.linear).to({rotation: -2, scaleX: 0.6, scaleY: 0.6}, 3000, createjs.Ease.linear);
		
		createjs.Tween.get().wait(8500).call(function(){
			animationComplete();
		});
	};
}
...
function Frame04(stage, assets) {
	...
	var headline_4 = new Glintable(new createjs.Bitmap(assets.headline_4.img), 0.8, 4);
	...
	airBalloon_2.x = balloonContainer.getBounds().width * 0.5;
	airBalloon_2.y = 275;
	...
	balloonContainer.x = stage.canvas.width + airBalloon_2.image.width - stage.canvas.width;
	...
	this.animate = function(animationComplete) { 
		...
		createjs.Tween.get(balloonContainer).to({x: 0}, 1000, createjs.Ease.linear).to({x: -10}, 2500).to({y: 0 - stage.canvas.height}, 1000);
		...
		createjs.Tween.get(headline_4).wait(1000).to({alpha: 1}, 500).call(function(){headline_4.playGlint();}).wait(2000).to({y: 0 - stage.canvas.height}, 1000);
		
		createjs.Tween.get().wait(4000).call(function(){
...
function Frame05(stage, assets) {
	...
	var headline_5 = new Glintable(new createjs.Bitmap(assets.headline_5.img), 0.8, 4);
	...
	this.animate = function(animationComplete) { 
		stage.getChildByName('balloonContainer').addChild(headline_5, headline_5_legal, bundle);
		
		createjs.Tween.get(bundle).to({alpha: 1, y: 0}, 1000, createjs.Ease.cubicOut).wait(2500).to({alpha: 0, y: stage.canvas.height }, 1000);
		
		createjs.Tween.get(headline_5).wait(1000).to({alpha: 1}, 500).call(function(){headline_5.playGlint();}).wait(2000).to({alpha: 0, y: stage.canvas.height }, 1000);
		createjs.Tween.get(headline_5_legal).wait(1000).to({alpha: 1}, 500).wait(2000).to({alpha: 0, y: stage.canvas.height}, 1000);
...
function Frame06(stage, assets) {
	...
	var headline_6_1 = new Glintable(new createjs.Bitmap(assets.headline_6_1.img), 0.6, 4);
	var headline_6_2 = new Glintable(new createjs.Bitmap(assets.headline_6_2.img), 0.8, 4);
	var cta = new Glintable(new createjs.Bitmap(assets.cta.img), 0.5, 4);
	...
	airBalloon_2.x = stage.canvas.width * 0.5;
	airBalloon_2.y = 340;
	...
	this.animate = function(animationComplete) { 
		...
		createjs.Tween.get(airBalloon_2).to({rotation: 2, scaleX: 1, scaleY: 1}, 3000);
		
		createjs.Tween.get(balloonContainer).to({y: 0}, 1000);
		
		createjs.Tween.get(headline_6_1).wait(1000).to({alpha: 1}, 750).wait(250).call(function() { headline_6_1.playGlint(); });
		createjs.Tween.get(headline_6_2).wait(1250).to({alpha: 1}, 750).call(function() { headline_6_2.playGlint(); });
		createjs.Tween.get(cta).wait(1500).to({alpha: 1}, 750).call(function() { cta.playGlint(); });
...
function SkyLegals() {
	...
	legalsCopy.innerHTML = dynamicContent.Feed_120x600[0].LegalCopy;
	legalsButton.innerHTML = dynamicContent.Feed_120x600[0].LegalButton;
