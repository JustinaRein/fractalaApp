...
function enablerInitHandler() {
    ...
    devDynamicContent.Feed_120x600[0].Active = true;
	...
	devDynamicContent.Feed_120x600[0].content = {
		"120x600_f2_image.png":{"Type":"file","Url":"dynamic_assets/120x600_f2_image.png"},
		"120x600_opening.png":{"Type":"file","Url":"dynamic_assets/120x600_opening.png"},
		"120x600_f2_copy.png":{"Type":"file","Url":"dynamic_assets/120x600_f2_copy.png"},
		"120x600_f2_copy_highlight.png":{"Type":"file","Url":"dynamic_assets/120x600_f2_copy_highlight.png"},
		"120x600_f3_copy.png":{"Type":"file","Url":"dynamic_assets/120x600_f3_copy.png"},
		"120x600_f3_copy_highlight.png":{"Type":"file","Url":"dynamic_assets/120x600_f3_copy_highlight.png"},
...
function adVisibilityHandler() {
    ...
    profile.f1LargeImage.url = dynamicContent.Feed_120x600[0].content['120x600_f2_image.png']['Url'];
	profile.f1StartOverlay.url = dynamicContent.Feed_120x600[0].content['120x600_opening.png']['Url'];
	
    profile.cta = dynamicContent.Feed_120x600[0].CtaCopy;
    profile.ctaX = dynamicContent.Feed_120x600[0].CtaXPos;
    profile.ctaY = dynamicContent.Feed_120x600[0].CtaYPos;
...
(function (window) {
    ...
    function Main(profile) {
        ...
        f2Text = new Glintable(styling, dynamicContent.Feed_120x600[0].content['120x600_f2_copy.png']['Url'], dynamicContent.Feed_120x600[0].content['120x600_f2_copy_highlight.png']['Url']);
        f2Text.alpha = 0;

        f5Copy = new Glintable(styling, dynamicContent.Feed_120x600[0].content['120x600_f3_copy.png']['Url'], dynamicContent.Feed_120x600[0].content['120x600_f3_copy_highlight.png']['Url']);
        f5Copy.alpha = 0;
    ...
    function f1(profile) {
        ...
        TweenMax.to(largeImage, 0.7, {delay: 1.15, x: 62, y: 280, scaleX: 0.5, scaleY: 0.5});
