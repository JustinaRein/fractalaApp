...
function enablerInitHandler() {
    ...
    devDynamicContent.Feed_160x600[0].Active = true;
	...
	devDynamicContent.Feed_160x600[0].content = {
		"160x600_f2_image.png":{"Type":"file","Url":"dynamic_assets/160x600_f2_image.png"},
		"160x600_opening.png":{"Type":"file","Url":"dynamic_assets/160x600_opening.png"},
		"160x600_f2_copy.png":{"Type":"file","Url":"dynamic_assets/160x600_f2_copy.png"},
		"160x600_f2_copy_highlight.png":{"Type":"file","Url":"dynamic_assets/160x600_f2_copy_highlight.png"},
		"160x600_f3_copy.png":{"Type":"file","Url":"dynamic_assets/160x600_f3_copy.png"},
		"160x600_f3_copy_highlight.png":{"Type":"file","Url":"dynamic_assets/160x600_f3_copy_highlight.png"},
...
function adVisibilityHandler() {
    ...
    profile.f1StartOverlay.url = dynamicContent.Feed_160x600[0].content['160x600_opening.png']['Url'];
    profile.f1LargeImage.url = dynamicContent.Feed_160x600[0].content['160x600_f2_image.png']['Url'];
	
    profile.cta = dynamicContent.Feed_160x600[0].CtaCopy;
    profile.ctaX = dynamicContent.Feed_160x600[0].CtaXPos;
    profile.ctaY = dynamicContent.Feed_160x600[0].CtaYPos;
...
(function (window) {
    ...
    function Main(profile) {
        ...
        var styling = {xStart: -50, yStart: 0, width: 220, height: 450};

        f2Text = new Glintable(styling, dynamicContent.Feed_160x600[0].content['160x600_f2_copy.png']['Url'], dynamicContent.Feed_160x600[0].content['160x600_f2_copy_highlight.png']['Url']);
        f2Text.alpha = 0;

        f5Copy = new Glintable(styling, dynamicContent.Feed_160x600[0].content['160x600_f3_copy.png']['Url'], dynamicContent.Feed_160x600[0].content['160x600_f3_copy_highlight.png']['Url']);
        f5Copy.alpha = 0;
    ...
    function f1(profile) {
        ...
        TweenMax.to(F1StartOverlay, 0.2, {delay: 1.05, alpha: 0});
        TweenMax.to(largeImage, 0.7, {delay: 1.15, x: 82, y: 290, scaleX: 0.6, scaleY: 0.6});
    ...
    function f3(profile) {
        ...
        //TweenMax.to(largeImage, fadeTime, {alpha: 0, ease: fadeOutAnim});
        ...
        //TweenMax.to(F5EndProduct, fadeTime, {delay: fadeTime, alpha: 1, ease: fadeInAnim});
