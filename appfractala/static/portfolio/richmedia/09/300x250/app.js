...
function enablerInitHandler() {
    ...
    devDynamicContent.Feed_300x250[0].Active = true;
	...
	devDynamicContent.Feed_300x250[0].content = {
		"300x250_f2_image.png":{"Type":"file","Url":"dynamic_assets/300x250_f2_image.png"},
		"300x250_opening.png":{"Type":"file","Url":"dynamic_assets/300x250_opening.png"},
		"300x250_f2_copy.png":{"Type":"file","Url":"dynamic_assets/300x250_f2_copy.png"},
		"300x250_f2_copy_highlight.png":{"Type":"file","Url":"dynamic_assets/300x250_f2_copy_highlight.png"},
		"300x250_f3_copy.png":{"Type":"file","Url":"dynamic_assets/300x250_f3_copy.png"},
		"300x250_f3_copy_highlight.png":{"Type":"file","Url":"dynamic_assets/300x250_f3_copy_highlight.png"},
...
function adVisibilityHandler() {
    ...
    profile.f1StartOverlay.url = dynamicContent.Feed_300x250[0].content['300x250_opening.png']['Url'];
    profile.f1LargeImage.url = dynamicContent.Feed_300x250[0].content['300x250_f2_image.png']['Url'];
	
    profile.cta = dynamicContent.Feed_300x250[0].CtaCopy;
    profile.ctaX = dynamicContent.Feed_300x250[0].CtaXPos;
    profile.ctaY = dynamicContent.Feed_300x250[0].CtaYPos;
...
(function (window) {
    ...
    function Main(profile) {
        ...
        var styling = {xStart: -50, yStart: -10, width: 400, height: 250};

        f2Text = new Glintable(styling, dynamicContent.Feed_300x250[0].content['300x250_f2_copy.png']['Url'], dynamicContent.Feed_300x250[0].content['300x250_f2_copy_highlight.png']['Url']);
        f2Text.alpha = 0;

        f5Copy = new Glintable(styling, dynamicContent.Feed_300x250[0].content['300x250_f3_copy.png']['Url'], dynamicContent.Feed_300x250[0].content['300x250_f3_copy_highlight.png']['Url']);
        f5Copy.alpha = 0;
		...
		largeImage.scaleX = 1.4;
		largeImage.scaleY = 1.4;
		largeImage.x = 170;
        largeImage.y = 160;
    ...
    function f1(profile) {
        ...
        TweenMax.to(largeImage, 0.7, {delay: 1.15, x: 155, y: 125, scaleX: 0.6, scaleY: 0.6});
		
		//TweenMax.to(largeImage, 0.7, {delay: 1.15, x: 225, y: 125, scaleX: 0.6, scaleY: 0.6});
    ...
    function f5(profile) {
		...
		TweenMax.to(largeImage, fadeTime, {x: 225});
